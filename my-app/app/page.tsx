...
const sampleAlerts = [
  {
    ...
    createdAt: new Date(),
    expiresAt: new Date(typeof window !== 'undefined' ? Date.now() + 7 * 24 * 60 * 60 * 1000 : 0),
    acknowledged: false,
    category: "Risk",
  },
  {
    ...
    createdAt: new Date(),
    expiresAt: new Date(typeof window !== 'undefined' ? Date.now() + 14 * 24 * 60 * 60 * 1000 : 0),
    acknowledged: false,
    category: "Risk",
  },
  {
    ...
    createdAt: new Date(),
    expiresAt: new Date(typeof window !== 'undefined' ? Date.now() + 30 * 24 * 60 * 60 * 1000 : 0),
    acknowledged: false,
    category: "Test",
  },
  {
    ...
    createdAt: new Date(),
    expiresAt: new Date(typeof window !== 'undefined' ? Date.now() + 90 * 24 * 60 * 60 * 1000 : 0),
    acknowledged: false,
    category: "Prediction",
  },
  {
